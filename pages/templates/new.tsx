    ...
    <>
      ...
      */}
      <div className="h-screen">
        ...
        <div className="lg:mt-16 hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:border-r lg:border-gray-200 lg:pt-5 lg:pb-4 lg:bg-gray-100">
        ...
        <div className="lg:pl-64 flex flex-col">
          ...
          <div className="p-4 m-8 overflow-y-auto">
            <div className="h-screen flex items-center justify-center p-40 border-4 border-dotted">
              Content...
            </div>
          </div>
        </div>
