...
export const Nav1 = () => {
  return (
    <div className="h-screen lg:flex md:flex items-center justify-center border-4 border-dotted hidden relative">
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 w-full absolute top-0">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <button data-collapse-toggle="mobile-menu" className="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu" aria-expanded="false">
